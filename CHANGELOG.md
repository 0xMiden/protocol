...
- Set a 10-block expiration delta in standard faucet blocklist and allowlist policies, bounding
  stale reference-block reads of faucet policy state ([#3478](https://github.com/0xMiden/protocol/pull/3478)).
