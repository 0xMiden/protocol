...
### Changes
- Added the `RoleConfig` note (`RoleConfigNote` / `RoleConfigAction`) for triggering `RoleBasedAccessControl` management actions (grant / revoke role, set role admin, renounce role) on an account via a note ([#3248](https://github.com/0xMiden/protocol/pull/3248)).
