...
- MINT notes for a public faucet now carry the `NetworkAccountTarget` attachment that identifies them as network notes, and both MINT and BURN notes reject a caller-supplied attachment naming a different faucet ([#3433](https://github.com/0xMiden/protocol/issues/3433)).
