...
- Set a 10-block transaction expiration delta in the standard faucet blocklist and allowlist
  transfer policies to bound stale reference-block reads of faucet policy state
  ([#3478](https://github.com/0xMiden/protocol/pull/3478)).
