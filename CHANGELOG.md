...
- [BREAKING] AggLayer bridge token registration now rejects keys owned by another faucet, and token-key cleanup verifies ownership before clearing a mapping ([#3749](https://github.com/0xMiden/protocol/issues/3749)).
