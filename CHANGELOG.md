...
### Changes
- Refactored the standard access components (authority, rbac, pausable, ownable2step, warden) to separate exec-only helpers from the public interface ([#3276](https://github.com/0xMiden/protocol/pull/3276)).
