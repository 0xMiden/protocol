...
- Fixed `ERR_BURN_AMOUNT_BELOW_MIN_BURN_AMOUNT` to "amount to be burned must meet or exceed specified minimum burn amount" ([#3474](https://github.com/0xMiden/protocol/pull/3474)).
