...
- [BREAKING] Refactored `InitStorageData` to support native types ([#2230](https://github.com/0xMiden/miden-base/pull/2230), [#2296](https://github.com/0xMiden/miden-base/pull/2296)).
