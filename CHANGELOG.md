...
- [BREAKING] Renamed `basic_wallet::add_assets_to_account` to `basic_wallet::move_note_assets_to_account`, reflecting that the assets are removed from the active note rather than merely added to the account ([#3286](https://github.com/0xMiden/protocol/pull/3286)).
