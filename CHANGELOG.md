...
- Disabled asset callbacks on all AggLayer faucets by omitting their unrestricted send and receive policies; minting and burning remain restricted to the bridge owner ([#3783](https://github.com/0xMiden/protocol/issues/3783)).
