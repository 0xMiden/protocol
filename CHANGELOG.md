...
- Disabled asset callbacks on all AggLayer faucets by omitting their unrestricted send and receive policies ([#3783](https://github.com/0xMiden/protocol/issues/3783)).
