...
### Changes
- [BREAKING] Renamed the `miden-tx-batch-prover` crate to `miden-batch`, reflecting that it now executes, proves, and verifies transaction batches ([#3035](https://github.com/0xMiden/protocol/pull/3035)).
