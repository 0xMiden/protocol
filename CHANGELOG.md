...
- [BREAKING] `AccountBuilder` now rejects accounts that enable asset callbacks with a private account type, since holders of their assets could not load the issuer's state to dispatch the callbacks ([#3717](https://github.com/0xMiden/protocol/issues/3717), [#3812](https://github.com/0xMiden/protocol/pull/3812)).
