...
- Added the `AuthPassThrough` account component, which rejects any change to the account's state, never increments the nonce and creates no `TX_FEE` note ([#3709](https://github.com/0xMiden/protocol/issues/3709)).
