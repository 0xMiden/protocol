...
- Added Blocklist component (per-faucet user blocklist with `block_user`/`unblock_user` admin) and `if_not_blocklisted` transfer policy ([#2820])(https://github.com/0xMiden/protocol/pull/2820).
