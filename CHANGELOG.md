...
- Added a temporary rejection for `TokenPolicyManager` that registers an owner-gated mint or burn policy without the `Ownable2Step` component, and planned to be removed once components can declare dependencies generally ([#3527](https://github.com/0xMiden/protocol/pull/3527)).
