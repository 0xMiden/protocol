...
- The standard config note scripts now reject a non-public note, so a management action can no longer be dispatched from a hand-crafted private note carrying the same script and storage ([#3719](https://github.com/0xMiden/protocol/issues/3719)).
