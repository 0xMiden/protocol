...
### Changes
- Added the `OwnerConfig` note (`OwnerConfigNote` / `OwnerConfigAction`) for triggering `Ownable2Step` management actions (transfer / accept / renounce ownership) on an account via a note ([#3245](https://github.com/0xMiden/protocol/pull/3245)).
