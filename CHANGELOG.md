...
- Merged `BasicFungibleFaucet` and `NetworkFungibleFaucet` ([#2890](https://github.com/0xMiden/protocol/pull/2890)).
- Added `Authority` account component ([#2890](https://github.com/0xMiden/protocol/pull/2890)).
