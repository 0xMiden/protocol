...
- [BREAKING] Introduced `ProtocolConfig` that commits to all kernel's procedures, the fee asset ID and the security policy for recursive verification ([#3644](https://github.com/0xMiden/protocol/issues/3644)).
- [BREAKING] Renamed `ValidatorKeys` to `ValidatorConfig` and added a quorum to it ([#3644](https://github.com/0xMiden/protocol/issues/3644)).
