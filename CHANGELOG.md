...
- Bound AggLayer MINT notes to the resolved asset's faucet via asset-in-storage so a claim for one token cannot be minted by a different faucet on the same bridge ([#2911](https://github.com/0xMiden/protocol/pull/2911)).
