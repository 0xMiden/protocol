...
- Fixed `AssetVault::add_asset` replacing a stored non-fungible asset with the one it rejected as a duplicate ([#3868](https://github.com/0xMiden/protocol/pull/3868)).
