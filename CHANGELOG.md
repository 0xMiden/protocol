...
- Restricted indexed input-note asset removal to the account context while preserving active-note
  self-removal ([#3445](https://github.com/0xMiden/protocol/issues/3445)).
