...
- The PSWAP note script now rejects a `PswapAttachment` that does not consist of exactly one word, instead of letting the attachment write past the four locals of `get_current_depth` ([#3744](https://github.com/0xMiden/protocol/pull/3744)).
