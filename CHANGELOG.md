...
- Fixed `AuthNetworkAccount` accepting empty fee-only transactions, which let callers drain the
  account's native fee-asset vault ([#3734](https://github.com/0xMiden/protocol/issues/3734)).
