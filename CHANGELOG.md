...
- [BREAKING] `NetworkAccount::builder` now installs `BasicWallet` and `AuthNetworkAccount::new` allowlists the P2ID script root by default, so a network account can be deployed by consuming a P2ID note ([#3893](https://github.com/0xMiden/protocol/pull/3893)).
