...
- The AggLayer bridge now accepts `RbacActionNote`s, enabling on-chain rotation of its `ADMIN`, `FAUCET_MNGR`, `GER_INJECTOR`, and `GER_REMOVER` roles ([#2706](https://github.com/0xMiden/protocol/issues/2706)).
