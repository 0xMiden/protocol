...
impl PricedNote {
    ...
    pub const fn scenarios(&self) -> &'static [ExecutionBenchmark] {
        match self {
            ...
            PricedNote::AllowlistConfig => &[ExecutionBenchmark::ConsumeAllowlistConfigNetwork],
    ...
    pub fn committed_cycles(&self) -> u32 {
        match self {
            ...
            PricedNote::AllowlistConfig => {
                miden_standards::note::costs::ALLOWLIST_CONFIG_CONSUMPTION_CYCLES
            },
            PricedNote::PauseAction => {
    ...
    const fn table_const_name(&self) -> &'static str {
        match self {
            ...
            PricedNote::AllowlistConfig => "ALLOWLIST_CONFIG_CONSUMPTION_CYCLES",
    ...
    const fn doc_subject(&self) -> &'static str {
        match self {
            ...
            PricedNote::AllowlistConfig => "an ALLOWLIST_CONFIG",
...
mod tests {
    ...
    #[case::allowlist_config(PricedNote::AllowlistConfig)]
