...
- standards, consumed by a network account with the matching management components: FAUCET_POLICY_ACTION, PAUSE_ACTION, OWNER_ACTION, RBAC_ACTION (one representative action selector each; other selectors run the identical dispatch path)
