...
Large amounts of fungible and non-fungible [assets](../asset.md) can be stored in the account's vault. See the [Vault](vault.md) chapter for details on the underlying data structure, operations, and capacity.
