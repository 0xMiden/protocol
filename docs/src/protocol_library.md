...
| `upgrade`                      | Records the commitments describing an upgrade of the native account's code and storage. Currently a no-op beyond storing the commitments; the commitment formats are not yet defined.<br/><br/>**Inputs:** `[CODE_UPGRADE_COMMITMENT, STORAGE_UPGRADE_COMMITMENT]`<br/>**Outputs:** `[]`                | Native & Account |
