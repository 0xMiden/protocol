...
| `seal` | Permanently prevents further asset and attachment changes to an existing output note for the rest of the transaction. Repeated calls have no effect.<br/><br/>**Inputs:** `[note_idx]`<br/>**Outputs:** `[]` | Native |
