...
| `upgrade`                      | Initializes an upgrade of the native account's code, applied in the epilogue after the auth procedure.<br/><br/>**Inputs:** `[NEW_CODE_COMMITMENT, STORAGE_UPGRADE_COMMITMENT]`<br/>**Outputs:** `[]`                | Native & Account |
