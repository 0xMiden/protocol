...
| `add_array_attachment` | Adds an array attachment to the note specified by the note index. The ATTACHMENT_COMMITMENT is the hash commitment to a set of elements.<br/><br/>**Inputs:**<br/>`Operand Stack: [attachment_scheme, ATTACHMENT_COMMITMENT, note_idx]`<br/>`Advice map: { ATTACHMENT_COMMITMENT: [[ATTACHMENT_ELEMENTS]] }`<br/>**Outputs:** `[]`                                                                        | Native           |
