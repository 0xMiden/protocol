...
use crate::account::components::{
    StandardAccountComponent, basic_fungible_faucet_library, basic_wallet_library,
    multisig_guardian_library, multisig_library, network_fungible_faucet_library, no_auth_library,
    singlesig_acl_library, singlesig_library,
};
        ...
        for component in self.components.iter() {
            match component {
                ...
                AccountComponentInterface::AuthMultisigGuardian => {
                    component_proc_digests
                        .extend(multisig_guardian_library().mast_forest().procedure_digests());
                },
