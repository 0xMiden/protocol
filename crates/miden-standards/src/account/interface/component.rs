...
pub enum AccountComponentInterface {
    ...
    FungibleFaucet,
    /// Exposes procedures from the
    /// [`CodeInspection`][crate::account::inspection::CodeInspection] component.
    CodeInspection,
    /// Exposes procedures from the
    ...
    /// transactions that do not consume an input note or change the account before fee payment.
    AuthNetworkAccount,
