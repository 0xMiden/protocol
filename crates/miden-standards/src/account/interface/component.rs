...
use crate::account::auth::{AuthMultisig, AuthMultisigGuardian, AuthSingleSig, AuthSingleSigAcl};
...
pub enum AccountComponentInterface {
    ...
    AuthMultisig,
    /// Exposes procedures from the
    /// [`AuthMultisigGuardian`][crate::account::auth::AuthMultisigGuardian] module.
...
impl AccountComponentInterface {
    ...
    pub fn name(&self) -> String {
        match self {
            ...
            AccountComponentInterface::AuthMultisigGuardian => "Multisig Guardian".to_string(),
    ...
    pub fn is_auth_component(&self) -> bool {
        matches!(
            ...
            AccountComponentInterface::AuthSingleSig
                ...
                | AccountComponentInterface::AuthMultisigGuardian
    ...
    pub fn get_auth_methods(&self, storage: &AccountStorage) -> Vec<AuthMethod> {
        match self {
            ...
            AccountComponentInterface::AuthMultisigGuardian => {
                vec![extract_multisig_auth_method(
                    storage,
                    AuthMultisigGuardian::threshold_config_slot(),
