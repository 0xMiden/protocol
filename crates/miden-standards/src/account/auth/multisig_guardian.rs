...
/// per-procedure threshold overrides. With Guardian is configured,
/// multisig authorization is combined with Guardian authorization, so operations require both
/// multisig approval and a valid Guardian signature. This substantially mitigates low-threshold
/// state-withholding scenarios since the Guardian is expected to forward state updates to other
/// approvers.
///
