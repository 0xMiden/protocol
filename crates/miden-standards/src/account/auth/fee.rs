...
///
/// The multisig components bound what they accept here, since the rate reaches the VM from the
/// host: they require `faucet_id` to be the native fee faucet and cap the paid amount at twice
/// the computed fee, aborting the transaction otherwise.
///
