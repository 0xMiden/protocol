...
/// non-fungible faucets: it takes the faucet kind from the composition of the asset stored in the
/// note and calls the matching `receive_and_burn`. BURN notes are always public so they are
