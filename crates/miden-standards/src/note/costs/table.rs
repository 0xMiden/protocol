...
pub const FAUCET_POLICY_CONFIG_CONSUMPTION_CYCLES: u32 = 26893;

/// Cycles of consuming a PAUSE_CONFIG note (single benchmarked path).
pub const PAUSE_CONFIG_CONSUMPTION_CYCLES: u32 = 16947;

/// Cycles of consuming an OWNER_CONFIG note (single benchmarked path).
pub const OWNER_CONFIG_CONSUMPTION_CYCLES: u32 = 16541;

/// Cycles of consuming an RBAC_CONFIG note (single benchmarked path).
pub const RBAC_CONFIG_CONSUMPTION_CYCLES: u32 = 19803;
