...
/// Error Message: "invalid private state manager signature"
pub const ERR_INVALID_PSM_SIGNATURE: MasmError = MasmError::from_static_str("invalid private state manager signature");
...
/// Error Message: "number of approvers and procedure threshold must be u32"
pub const ERR_NUM_APPROVERS_OR_PROC_THRESHOLD_NOT_U32: MasmError = MasmError::from_static_str("number of approvers and procedure threshold must be u32");
...
/// Error Message: "private state manager is not initialized for this account"
pub const ERR_PSM_NOT_INITIALIZED: MasmError = MasmError::from_static_str("private state manager is not initialized for this account");
