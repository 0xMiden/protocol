...
/// - `miden::standards::auth::signature::auth_scheme`
...
impl SchemaType {
    ...
    pub fn auth_scheme() -> SchemaType {
        SchemaType::new("miden::standards::auth::signature::auth_scheme")
            .expect("type is well formed")
    }

    /// Returns the schema type for public key commitments.
    pub fn pub_key() -> SchemaType {
        SchemaType::new("miden::standards::auth::signature::pub_key").expect("type is well formed")
    }
