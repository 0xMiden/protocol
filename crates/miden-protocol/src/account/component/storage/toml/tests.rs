...
use crate::account::component::{
    ...
    SchemaTypeId, StorageSlotSchema, StorageValueName, StorageValueNameError, WordSchema,
    WordValue,
};
...
fn metadata_toml_round_trip_typed_slots() {
    let toml_str = r#"
        ...
        [[storage.slots]]
        name = "demo::typed_map"
        type = { key = "miden::standards::auth::signature::pub_key", value = "miden::standards::auth::signature::pub_key" }
    "#;
    ...
    let pub_key_type = SchemaTypeId::new("miden::standards::auth::signature::pub_key").unwrap();
