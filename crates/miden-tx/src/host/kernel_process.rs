...
use miden_protocol::transaction::memory::{
    ACCOUNT_STACK_TOP_PTR, ACCT_CODE_COMMITMENT_OFFSET, ACCT_ID_PREFIX_IDX, ACCT_ID_SUFFIX_IDX,
    ACCT_STORAGE_SLOT_ID_PREFIX_OFFSET, ACCT_STORAGE_SLOT_ID_SUFFIX_OFFSET,
    ACCT_STORAGE_SLOT_TYPE_OFFSET, ACCT_STORAGE_SLOT_VALUE_OFFSET, ACTIVE_INPUT_NOTE_PTR,
    NATIVE_NUM_ACCT_STORAGE_SLOTS_PTR, NUM_OUTPUT_NOTES_PTR,
};
