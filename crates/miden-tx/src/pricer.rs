...
/// ([`AgglayerNote::note_cost`]), pricing agglayer and standard notes through a single pricer;
/// pass [`StandardNote::note_cost`](miden_standards::note::StandardNote::note_cost) or a
/// custom lookup to narrow or extend it.
///
