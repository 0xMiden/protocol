...
//! The `NetworkNotePricer` in `miden-tx` turns cycle costs into fees; its default lookup
//! ([`AgglayerNote::note_cost`](crate::AgglayerNote::note_cost)) prices agglayer and standard
