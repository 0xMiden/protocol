...
use miden_standards::note::{BurnNote, FeeNote, MintNote, P2idNote, P2ideNote, SwapNote};
...
impl MockChainBuilder {
    ...
    /// Creates a new FEE note from the provided parameters and adds it to the list of genesis
    /// notes.
    ///
