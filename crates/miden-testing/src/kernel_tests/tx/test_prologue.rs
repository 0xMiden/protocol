...
use miden_protocol::account::{
    Account, AccountBuilder, AccountHeader, AccountProcedureRoot, AccountType, StorageSlot,
    StorageSlotName,
};
...
use miden_protocol::transaction::memory::{
    ACCT_DB_ROOT_PTR, ASSET_SIZE, ASSET_VALUE_OFFSET, BLOCK_COMMITMENT_PTR, BLOCK_METADATA_PTR,
    BLOCK_NUMBER_IDX, CHAIN_COMMITMENT_PTR, FEE_FAUCET_ID_PREFIX_IDX, FEE_FAUCET_ID_SUFFIX_IDX,
    FEE_PARAMETERS_PTR, GLOBAL_ACCOUNT_ID_PREFIX_PTR, GLOBAL_ACCOUNT_ID_SUFFIX_PTR,
    INIT_ACCT_COMMITMENT_PTR, INIT_NATIVE_ACCT_STORAGE_COMMITMENT_PTR,
    INIT_NATIVE_ACCT_VAULT_ROOT_PTR, INIT_NONCE_PTR, INPUT_NOTE_ARGS_OFFSET,
    INPUT_NOTE_ASSETS_COMMITMENT_OFFSET, INPUT_NOTE_ASSETS_OFFSET,
    INPUT_NOTE_ATTACHMENTS_COMMITMENT_OFFSET, INPUT_NOTE_DETAILS_COMMITMENT_OFFSET,
    INPUT_NOTE_METADATA_OFFSET, INPUT_NOTE_NULLIFIER_SECTION_PTR, INPUT_NOTE_NUM_ASSETS_OFFSET,
    INPUT_NOTE_RECIPIENT_OFFSET, INPUT_NOTE_SCRIPT_ROOT_OFFSET, INPUT_NOTE_SECTION_PTR,
    INPUT_NOTE_SERIAL_NUM_OFFSET, INPUT_NOTE_STORAGE_COMMITMENT_OFFSET, INPUT_NOTES_COMMITMENT_PTR,
    KERNEL_PROCEDURES_PTR, NATIVE_ACCT_CODE_COMMITMENT_PTR, NATIVE_ACCT_ID_AND_NONCE_PTR,
