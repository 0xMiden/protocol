...
use miden_protocol::account::{
    Account, AccountBuilder, AccountProcedureRoot, AccountStorageMode, AccountType, StorageSlot,
    StorageSlotName,
};
...
use miden_protocol::transaction::memory::{
    ...
    INPUT_NOTE_ATTACHMENT_OFFSET, INPUT_NOTE_ID_OFFSET, INPUT_NOTE_METADATA_HEADER_OFFSET,
    ...
    INPUT_NOTE_STORAGE_COMMITMENT_OFFSET, INPUT_NOTES_COMMITMENT_PTR, KERNEL_PROCEDURES_PTR,
    ...
    NATIVE_ACCT_STORAGE_SLOTS_SECTION_PTR, NATIVE_ACCT_VAULT_ROOT_PTR, NATIVE_ASSET_ID_PREFIX_IDX,
    NATIVE_ASSET_ID_SUFFIX_IDX, NATIVE_NUM_ACCT_PROCEDURES_PTR, NATIVE_NUM_ACCT_STORAGE_SLOTS_PTR,
    NOTE_ROOT_PTR, NULLIFIER_DB_ROOT_PTR, NUM_KERNEL_PROCEDURES_PTR,
    PARTIAL_BLOCKCHAIN_NUM_LEAVES_PTR, PARTIAL_BLOCKCHAIN_PEAKS_PTR, PREV_BLOCK_COMMITMENT_PTR,
    PROTOCOL_VERSION_IDX, TIMESTAMP_IDX, TX_COMMITMENT_PTR, TX_KERNEL_COMMITMENT_PTR,
    TX_SCRIPT_ROOT_PTR, VALIDATOR_KEY_COMMITMENT_PTR, VERIFICATION_BASE_FEE_IDX,
};
