...
use miden_protocol::asset::{
    AssetClass, AssetComposition, AssetId, FungibleAsset, NonFungibleAsset, NonFungibleAssetDetails,
};
use miden_protocol::errors::MasmError;
use miden_protocol::errors::protocol::ERR_VAULT_ASSET_METADATA_NON_ZERO_RESERVED_BITS;
use miden_protocol::errors::tx_kernel::{
    ERR_FUNGIBLE_ASSET_AMOUNT_EXCEEDS_MAX_AMOUNT, ERR_FUNGIBLE_ASSET_ID_ASSET_CLASS_MUST_BE_ZERO,
    ...
    ERR_NON_FUNGIBLE_ASSET_ID_COMPOSITION_MUST_BE_NON_FUNGIBLE, ERR_VAULT_ASSET_METADATA_NOT_U32,
