...
use miden_protocol::transaction::memory::{
    NOTE_MEM_SIZE, OUTPUT_NOTE_ASSETS_COMMITMENT_OFFSET, OUTPUT_NOTE_SECTION_OFFSET,
};
...
use crate::{
    Auth, MockChain, TestTransactionBuilder, TxContextInput, assert_execution_error,
